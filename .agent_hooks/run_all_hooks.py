...
The hook type is the name of the directory in the `BASE_DIR` directory (default: /workspace/openclaw-whatsapp/.agent_hooks).
The logs are stored in the `LOG_DIR` directory (default: /workspace/openclaw-whatsapp/.agent_hooks/<hook_type>/_logs).
...
BASE_DIR = Path("/workspace/openclaw-whatsapp/.agent_hooks")
LOG_DIR_NAME = "_logs"
